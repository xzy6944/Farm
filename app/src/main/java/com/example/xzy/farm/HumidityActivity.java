...
public class HumidityActivity extends Activity{
    ...
    private void showPopwindow() {
        ...
        ((TextView) view.findViewById(R.id.down)).setText("减湿");
        ((TextView) view.findViewById(R.id.up)).setText("增湿");
        ...
        // 在底部显示
        window.showAtLocation(HumidityActivity.this.findViewById(R.id.display_detail),
                Gravity.BOTTOM, 0, 0);
